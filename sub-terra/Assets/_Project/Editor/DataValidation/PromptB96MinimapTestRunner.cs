...
{
    /// <summary>prompt-B 96 미니맵 남은 타일 도트 표시 테스트를 실행한다.</summary>
    public static class PromptB96MinimapTestRunner
    {
        ...
        private static void WatchRequest()
        {
            ...
            {
                const string flag = "Temp/subterra-run-prompt-b96.flag";
        ...
        [MenuItem("SubTerra/Tests/Run Prompt-B 96 Minimap Tests")]
        ...
        public static void RunEditMode()
        {
            ...
            var path = Path.GetFullPath(Path.Combine(
                Application.dataPath, "..", "Temp", "prompt-b96-editmode-results.txt"));
            if (File.Exists(path))
            {
                File.Delete(path);
            }
            ...
            receiver = new ResultWriter(path, "Prompt-B 96 EditMode");
            ...
            Debug.Log("[SubTerra] Prompt-B 96 EditMode tests requested → " + path);
        }
        ...
        private sealed class ResultWriter : ICallbacks
        {
            ...
            public void RunFinished(ITestResultAdaptor result)
            {
                ...
                Debug.Log($"[SubTerra] Prompt-B 96 finished Pass={passed} Fail={failed} Skip={skipped}");
