...
{
    /// <summary>prompt-B 106 메뉴 연결과 전환을 검증한다.</summary>
    public static class PromptB106HudTestRunner
    {
        ...
        private static void WatchRequest()
        {
            ...
            {
                const string flag = "Temp/subterra-run-prompt-b106.flag";
        ...
        [MenuItem("SubTerra/Tests/Run Prompt-B 106 Player HUD Tests")]
        ...
        private static void Run(bool runPlayMode)
        {
            ...
            var path = Path.GetFullPath(Path.Combine(
                Application.dataPath, "..", "Temp", runPlayMode ? "prompt-b106-playmode-results.txt" : "prompt-b106-editmode-results.txt"));
            if (File.Exists(path))
            {
                File.Delete(path);
            }
            ...
            receiver = new ResultWriter(path, runPlayMode ? "Prompt-B 106 PlayMode" : "Prompt-B 106 EditMode");
            ...
            api.Execute(new ExecutionSettings(new Filter
            {
                ...
                groupNames = runPlayMode ? new[] { "SubTerra.App.Tests.PlayMode.PromptB106HudPlayModeTests" } : new[] { "SubTerra.App.Tests.UI.PromptB106HudTests", "SubTerra.App.Tests.UI.HudStaticStructureTests", "SubTerra.App.Tests.UI.HudPresenterTests", "SubTerra.App.Tests.UI.HudFormatterTests" }
            }));
            Debug.Log("[SubTerra] Prompt-B 106 tests requested → " + path);
        }
        ...
        private sealed class ResultWriter : ICallbacks
        {
            ...
            public void RunFinished(ITestResultAdaptor result)
            {
                ...
                Debug.Log($"[SubTerra] Prompt-B 106 finished Pass={passed} Fail={failed} Skip={skipped}");
