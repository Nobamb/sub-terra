...
namespace SubTerra.App.UI.HUD
{
    ...
    public sealed class GameGuidePanelView : MonoBehaviour
    {
        ...
        private const string MechanicsBody =
            ...
            + "광산 초기화 주기\n"
            + "· 플레이 시간 3시간이 지나면 지하 광산이 자동으로 초기화되고 지상으로 이동합니다.\n"
            + "· 지상에서 골드로 광산을 초기화하면 3시간 타이머가 처음부터 다시 시작됩니다. 비용은 500G에서 시작해 초기화할 때마다 2배가 됩니다.\n"
            + "· 3시간 자동 초기화가 발생하면 유료 비용은 다시 500G가 됩니다.\n"
            + "· 남은 시간은 화면 상단 중앙의 전자시계로 확인할 수 있으며, T 키로 시계를 열거나 닫습니다.";
